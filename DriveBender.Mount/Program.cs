...
internal static class Program {
  ...
  private static int Main(string[] args) {
    ...
    var verbTypes = new[] {
      ...
      typeof(PoolTrashListOptions), typeof(PoolTrashRestoreOptions), typeof(PoolTrashPurgeOptions),
      typeof(PoolSnapshotTakeOptions), typeof(PoolSnapshotListOptions), typeof(PoolSnapshotDeleteOptions), typeof(PoolSnapshotRestoreOptions),
    ...
    return Parser.Default.ParseArguments(_TranslateVerbs(args), verbTypes).MapResult(
      parsed => _Guard(() => parsed switch {
        ...
        PoolHealthOptions o => PoolOpsCommand.Health(host, provider, remoteResolver, mountRegistry, o),
        PoolRestoreOptions o => PoolOpsCommand.Restore(host, provider, remoteResolver, mountRegistry, o),
        PoolSnapshotTakeOptions o => PoolOpsCommand.SnapshotTake(provider, mountRegistry, o),
        PoolSnapshotListOptions o => PoolOpsCommand.SnapshotList(provider, mountRegistry, o),
        PoolSnapshotDeleteOptions o => PoolOpsCommand.SnapshotDelete(provider, mountRegistry, o),
        PoolSnapshotRestoreOptions o => PoolOpsCommand.SnapshotRestore(provider, mountRegistry, o),
        PoolTrashListOptions o => PoolOpsCommand.TrashList(host, provider, remoteResolver, o),
        PoolTrashRestoreOptions o => PoolOpsCommand.TrashRestore(host, provider, remoteResolver, mountRegistry, o),
        PoolTrashPurgeOptions o => PoolOpsCommand.TrashPurge(host, provider, remoteResolver, mountRegistry, o),
        PoolRemoveMediaOptions o => PoolOpsCommand.RemoveMedia(host, store, provider, lifecycle, remoteResolver, mountRegistry, o),
        PoolReplaceMediaOptions o => PoolOpsCommand.ReplaceMedia(host, store, provider, lifecycle, remoteResolver, mountRegistry, o),
