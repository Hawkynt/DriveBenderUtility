...
| --- | --- | --- | ---: |
| RAM cache | sequential write, 1.5 GiB | 1 | 996 MiB/s |
| RAM cache | sequential read, 1.5 GiB | 1 | 2,612 MiB/s |
| Storage | sequential write, 1.5 GiB | 1 | 1,099 MiB/s |
| Storage | sequential read, 1.5 GiB | 1 | 1,549 MiB/s |
| Landing | sequential write, 1.5 GiB | 1 | 1,071 MiB/s |
| RAM ack | sequential write, 1.5 GiB (opt-in) | 1 | 1,016 MiB/s |
| RAM ack | vs. durability-first default | 1 | 1.02x |
| RAM cache | random 4 KiB read | 1 | 69,137 IOPS |
| RAM cache | random 4 KiB read | 20 | 52,683 IOPS |
| Storage | random 4 KiB read | 1 | 2,986 IOPS |
| Storage | random 4 KiB read | 20 | 3,342 IOPS |
| RAM cache | random 4 KiB read scaling | 1 -> 20 | 76 % of single-thread |
| Storage | create+write+close, 3072 B | 1 | 120 IOPS |
| Storage | create+write+close, 3072 B | 20 | 152 IOPS |
| Landing | create+write+close, 3072 B | 20 | 164 IOPS |
| RAM cache | open+read+close, 3072 B | 1 | 2,599 IOPS |
| RAM cache | open+read+close, 3072 B | 20 | 7,541 IOPS |
| RAM cache | open+read+close scaling, 3072 B | 1 -> 20 | 2.9x |
| Scatter | sequential read, 512 MiB, queue depth 1 | 1 | 1,996 MiB/s |
| Scatter | sequential read, 512 MiB, overlapped | 1 | 1,661 MiB/s |
| Scatter | overlapped vs. queue depth 1 | 1 | 0.83x |
| Scatter | sequential read, 512 MiB, 2 copies | 1 | 1,807 MiB/s |
