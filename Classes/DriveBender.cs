...
public static partial class DriveBender {
  ...
  private class PoolDriveWithoutPool(string label, string description, Guid id, DirectoryInfo root) {
  ...
  private class Volume(IMountPoint mountPoint, string label, string description, Guid id, DirectoryInfo root)
